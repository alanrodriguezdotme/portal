 ...
 */
// baked material
debugObject.portalColorStart = "#c8e3ee";
...
// gui.add(camera.position, "x", -50, 50, 0.1).name("cameraX");
// gui.add(camera.position, "y", -50, 50, 0.1).name("cameraY");
// gui.add(camera.position, "z", -50, 50, 0.1).name("cameraZ");
